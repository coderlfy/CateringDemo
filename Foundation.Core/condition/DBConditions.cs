...
namespace Foundation.Core
{
    public class DBConditions
    {
        ...
        */
        ...
        public void AddBrackte(SplitBracket splitBrackte)
        {
            #region
            this.Add(new DBCondition()
            {
                _SplitBracket = splitBrackte
            });
            #endregion
        }
        public void AddAndCondition(string fieldName,
        ...
        public override string ToString()
        {
            ...
            if (this._DBConditions != null)
            {
                for (int i = 0; i < this._DBConditions.Count; i++)
                {
                    ...
                    switch (condition._SplitBracket)
                    {
                        case SplitBracket.LEFT:
                            allconditions += "(";
                            break;
                        case SplitBracket.RIGHT:
                            allconditions = allconditions.Insert(allconditions.Length - 5, ")");
                            break;
                        default:
