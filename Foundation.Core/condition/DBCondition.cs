...
namespace Foundation.Core
{
    ...
    public class DBCondition
    {
        ...
        private const string conditionInValuesFormat 
            = " ({0} in ({1})) {2} ";
        private SplitBracket _splitBracket = SplitBracket.NULL;

        public SplitBracket _SplitBracket
        {
            get { return _splitBracket; }
            set { _splitBracket = value; }
        }
